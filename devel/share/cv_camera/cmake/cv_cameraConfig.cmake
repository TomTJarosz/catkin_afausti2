...
if("TRUE" STREQUAL "TRUE")
  set(cv_camera_SOURCE_PREFIX /home/youbot/catkin_afausti2/src/drivers/cv_camera)
  set(cv_camera_DEVEL_PREFIX /home/youbot/catkin_afausti2/devel)
  ...
  set(cv_camera_INSTALL_PREFIX /home/youbot/catkin_afausti2/install)
...
if(NOT "/home/youbot/catkin_afausti2/src/drivers/cv_camera/include " STREQUAL " ")
  set(cv_camera_INCLUDE_DIRS "")
  set(_include_dirs "/home/youbot/catkin_afausti2/src/drivers/cv_camera/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'cv_camera' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/youbot/catkin_afausti2/src/drivers/cv_camera/${idir}'.  Ask the maintainer 'Takashi Ogura <t.ogura@gmail.com>' to fix it.")
    endif()
    _list_append_unique(cv_camera_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "cv_camera")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${cv_camera_dep}_FOUND)
      find_package(${cv_camera_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${cv_camera_dep} REQUIRED ${depend_list})
  endif()
