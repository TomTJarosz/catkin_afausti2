...
Matrix4f DH2HT(float a, float alpha, float d, float theta)
{
	...
	HT << cos(theta), -cos(alpha)*sin(theta), sin(alpha)*sin(theta), a*cos(theta),
...
cout <<	DH2HT(0.0,-PI/2.0,152.0,theta1)*
				DH2HT(244.0,0.0,120.0,theta2)*
				DH2HT(213.0,0.0,-93.0,theta3)*
				DH2HT(0.0,-PI/2.0,83.0,theta4)*
				DH2HT(0.0,PI/2.0,83.0,theta5)*
				DH2HT(53.5,PI,138.0,theta6)<<endl;
